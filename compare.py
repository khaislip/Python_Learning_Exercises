...
with open('neo3_ecs_rules_only_latest.txt') as inputFile1, open('normalized_inputFile1.txt', 'w') as outputFile1:
 for line in inputFile1:
   outputFile1.write(line.strip(' \t\n\r')) #get rid of all whitespace
   outputFile1.write('\n')

with open ('normalized_inputFile1_final.txt', 'w') as outputFile1_final:
 outputFile1_final.write(os.linesep.join([l for l in open("normalized_inputFile1.txt","r").read().splitlines() if l])) #get rid of blank lines 

#normalizes file2 of whitespace
...
with open ('normalized_inputFile2_final.txt', 'w') as outputFile2_final:
 outputFile2_final.write(os.linesep.join([l for l in open("normalized_inputFile2.txt","r").read().splitlines() if l])) #get rid of blank lines 
